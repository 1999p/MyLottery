...
public abstract class BaseActivityPartake extends ActivityPartakeSupport implements IActivityPartake {
    ...
    public PartakeResult doPartake(PartakeReq req) {
        ...
        UserTakeActivityVO userTakeActivityVO = this.queryNoConsumedTakeActivity(req.getActivityId(), req.getuId());
     ...
     * @return 领取单
     */
    protected abstract UserTakeActivityVO queryNoConsumedTakeActivity(Long activityId,String uId);
