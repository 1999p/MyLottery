package cn.xyr.lottery.domain.strategy.service.draw.impl;


import cn.xyr.lottery.domain.strategy.service.algorithm.IDrawAlgorithm;
import cn.xyr.lottery.domain.strategy.service.draw.AbstractDrawBase;
...
/**
 * @className: cn.xyr.lottery.domain.strategy.service.draw.impl.DrawExecImpl
 * @description: TODO 抽奖过程方法实现
 * @author: xyr
...
public class DrawExecImpl extends AbstractDrawBase {
    ...
    protected String drawAlgorithm(Long strategyId, IDrawAlgorithm drawAlgorithm, List<String> excludeAwardIds) {
         ...
         * 但此种方式需要了解，因为在分库分表下的正常数据流量下的个人数据记录中，是可以使用行级锁的，因为他只影响到自己的记录，不会影响到其他人
         */
