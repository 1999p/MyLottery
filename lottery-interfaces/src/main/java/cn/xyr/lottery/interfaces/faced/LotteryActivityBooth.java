package cn.xyr.lottery.interfaces.faced;
...
import cn.xyr.lottery.interfaces.assembler.IMapping;
...
public class LotteryActivityBooth implements ILotteryActivityBooth {
    ...
    public DrawRes doDraw(DrawReq drawReq) {
        try {
            ...
            // 1.执行抽奖
            DrawProcessResult drawProcessResult = activityProcess.doDrawProcessResult(new DrawProcessReq(drawReq.getuId(), drawReq.getActivityId()));
    ...
    public DrawRes doQuantificationDraw(QuantificationDrawReq quantificationDrawReq) {
        try {
            ...
            DrawProcessResult drawProcessResult = activityProcess.doDrawProcessResult(new DrawProcessReq(quantificationDrawReq.getuId(), activityId));
            if (!Constants.ResponseCode.SUCCESS.getCode().equals(drawProcessResult.getCode())){
